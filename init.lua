...
vim.keymap.set('n', '<C-E>', '<cmd>Neotree reveal<enter>', { desc = 'Open Neotree' })
vim.keymap.set('n', 'zm', '<cmd>ZenMode<enter>', { desc = 'Enters ZenMode' })
...
require('lazy').setup({
  ...
  'numToStr/Comment.nvim', -- Adds toggle commenting
  { -- Pairs {} [] ()
